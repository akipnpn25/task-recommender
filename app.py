...
def get_recommendation_status(best):
    """推薦結果を分かりやすい状態に変換する"""
    ...
    progress,
            ...
            with st.container(
                ...
                with col2:
                    st.write(
                        f"⏱️ 約"
                        f"{format_minutes(estimated_minutes)}"
                    )
                ...
                with st.expander(
                    ...
                    edited_time_label = st.selectbox(
                        "予想所要時間",
                        list(
